...
#reedit csntumin yt gw ya jingan!
#izin ke 083141727903
...
req=reek.Session()
os.system('clear')
title=pyfiglet.figlet_format("BOM SMS\nBY IKY ADS")
p = "\033[1;91m"
h = "\33[32;1m"
m = "\033[1;91m"
ber=0
		...
		try:
			...
			if a in(""," "):print("[!] Jangan Kosong kak")
				...
				try:
					...
					cok()
				time.sleep(2)
				print("\n[+] Sedang Menyepam Subrek Iky Ads...")
				b=a[1:12] 
				c="62"+b
...
def memek():
	print(f"{h}"+title+f"{p}\nSUBSCRIBE:Iky Ads\nIG:@Iky_Ads\nWa:083141727903 | 16 Operator Otp{p}\n\nJangan Disalah Gunakan Kak Dosa Tanggung Sendiri\nJumlah Spam Dikalikan Dengan 16\nContoh Jumlah Spam 2\nJadinya 2 Dikali 16 Spamnya 32\n")
